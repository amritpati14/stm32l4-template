...
#define MOISTURE_SENSOR0_GPIO_PORT				GPIOC
#define MOISTURE_SENSOR0_GPIO_PIN				GPIO_PIN_0
#define MOISTURE_SENSOR0_PIN					MOISTURE_SENSOR0_GPIO_PORT, MOISTURE_SENSOR0_GPIO_PIN
#define MOISTURE_SENSOR1_GPIO_PORT				GPIOC
#define MOISTURE_SENSOR1_GPIO_PIN				GPIO_PIN_1
#define MOISTURE_SENSOR1_PIN					MOISTURE_SENSOR1_GPIO_PORT, MOISTURE_SENSOR1_GPIO_PIN
#define MOISTURE_SENSOR2_GPIO_PORT				GPIOB
#define MOISTURE_SENSOR2_GPIO_PIN				GPIO_PIN_0
#define MOISTURE_SENSOR2_PIN					MOISTURE_SENSOR2_GPIO_PORT, MOISTURE_SENSOR2_GPIO_PIN
#define MOISTURE_SENSOR3_GPIO_PORT				GPIOA
#define MOISTURE_SENSOR3_GPIO_PIN				GPIO_PIN_4
#define MOISTURE_SENSOR3_PIN					MOISTURE_SENSOR3_GPIO_PORT, MOISTURE_SENSOR3_GPIO_PIN

#define MOISTURE_SENSOR_0						ADC_CHANNEL_1 // PC0
#define MOISTURE_SENSOR_1						ADC_CHANNEL_2 // PC1
#define MOISTURE_SENSOR_2						ADC_CHANNEL_15 // PB0
#define MOISTURE_SENSOR_3						ADC_CHANNEL_9 // PA4
